...
- **Spawner Tab**: Spawn stations - from a construction plan or as a pre-built installation - plus ships (loadout, crew skills, job assignment) and deployable objects. Player stations can be given a manager, a ship trader and a starting workforce - none of which the game assigns itself.
...
![Encyclopedia Tab](docs/images/encyclopedia.png)
...
- The construction plan is identified against your saved and in-game plans, or shown as **Unknown**; a pre-built installation is named as one. It cannot be changed.
...
- **Added**
  ...
  - Spawner tab: **Pre-built Installations** as a third station type, in extended mode - Kha'ak installations, the fixed Xenon and pirate stations and the like, listed from the game itself.
